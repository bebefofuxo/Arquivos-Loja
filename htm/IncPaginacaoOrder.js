...
document.getElementById('idPagProdTop').innerHTML="<div id='idDivPagProd'><table width='100%' bgcolor='#f7f7f7' height='30'><tr><td>"+ sOrdenacao +"</td><td><table id=idPaginationProdTopFC cellpadding=0 cellspacing=0 width=100% align=center>"+ oPaginationProd.innerHTML +"</td></tr></table></td></tr></table></div>";
