...
function ShowCEPInfo(IDProduto){
  ...
  */
  ...
  sCEP+="    <td align='center' style='line-height:1.5;padding-right:10px;padding-left:10px;vertical-align: middle;'><strong>Estado de São Paulo:</strong> compras acima de <strong>R$ 99,00</strong></td>";
  
  sCEP+="  </tr>";
  
  sCEP+="  <tr height='30'>";
  
  sCEP+="    <td align='center' style='line-height:1.5;padding-right:10px;padding-left:10px;vertical-align: middle;'><strong>Regiões Nordeste e Norte:</strong> compras acima de <strong>R$ 199,00</strong></td>";
  
  sCEP+="  </tr>";
  
  sCEP+="  <tr height='30'>";
  
  sCEP+="    <td align='center' style='line-height:1.5;padding-right:10px;padding-left:10px;vertical-align: middle;'><strong>Demais estados do Brasil:</strong> compras acima de <strong>R$ 150,00</strong></td>";
